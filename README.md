...
[![Test](https://github.com/NpoolPlatform/cloud-hashing-inspire/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/cloud-hashing-inspire/actions/workflows/main.yml)
...
* make cloud-hashing-inspire ```单独编译服务```
* make cloud-hashing-inspire-image ```单独生成服务镜像```
