...
[![Test](https://github.com/NpoolPlatform/cloud-hashing-stimulate/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/cloud-hashing-stimulate/actions/workflows/main.yml)
...
* make cloud-hashing-stimulate ```单独编译服务```
* make cloud-hashing-stimulate-image ```单独生成服务镜像```
