...
// Returns a *NotSingularError when more than one CouponPool entity is found.
...
// Returns a *NotSingularError when more than one CouponPool ID is found.
...
func (cpq *CouponPoolQuery) GroupBy(field string, fields ...string) *CouponPoolGroupBy {
	grbuild := &CouponPoolGroupBy{config: cpq.config}
	...
	grbuild.label = couponpool.Label
...
func (cpq *CouponPoolQuery) Select(fields ...string) *CouponPoolSelect {
	...
	selbuild := &CouponPoolSelect{CouponPoolQuery: cpq}
	selbuild.label = couponpool.Label
...
func (cpq *CouponPoolQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*CouponPool, error) {
	var (
		nodes = []*CouponPool{}
		_spec = cpq.querySpec()
	)
	_spec.ScanValues = func(columns []string) ([]interface{}, error) {
		return (*CouponPool).scanValues(nil, columns)
	}
...
func (cpq *CouponPoolQuery) Modify(modifiers ...func(s *sql.Selector)) *CouponPoolSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (cps *CouponPoolSelect) Modify(modifiers ...func(s *sql.Selector)) *CouponPoolSelect {
