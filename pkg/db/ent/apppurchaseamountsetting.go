...
func (*AppPurchaseAmountSetting) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case apppurchaseamountsetting.FieldID, apppurchaseamountsetting.FieldAppID, apppurchaseamountsetting.FieldUserID, apppurchaseamountsetting.FieldCoinTypeID, apppurchaseamountsetting.FieldGoodID:
...
func (apas *AppPurchaseAmountSetting) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", apas.CoinTypeID))
	builder.WriteString(", ")
