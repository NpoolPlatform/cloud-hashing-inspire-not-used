...
func init() {
	...
	appcommissionsettingDescCreateAt := appcommissionsettingFields[7].Descriptor()
	...
	appcommissionsettingDescUpdateAt := appcommissionsettingFields[8].Descriptor()
	...
	appcommissionsettingDescDeleteAt := appcommissionsettingFields[9].Descriptor()
	...
	apppurchaseamountsettingDescCreateAt := apppurchaseamountsettingFields[10].Descriptor()
	...
	apppurchaseamountsettingDescUpdateAt := apppurchaseamountsettingFields[11].Descriptor()
	...
	apppurchaseamountsettingDescDeleteAt := apppurchaseamountsettingFields[12].Descriptor()
	...
	registrationinvitationMixin := schema.RegistrationInvitation{}.Mixin()
	registrationinvitation.Policy = privacy.NewPolicies(registrationinvitationMixin[0], schema.RegistrationInvitation{})
	registrationinvitation.Hooks[0] = func(next ent.Mutator) ent.Mutator {
		return ent.MutateFunc(func(ctx context.Context, m ent.Mutation) (ent.Value, error) {
			if err := registrationinvitation.Policy.EvalMutation(ctx, m); err != nil {
				return nil, err
			}
			return next.Mutate(ctx, m)
		})
	}
	registrationinvitationMixinFields0 := registrationinvitationMixin[0].Fields()
	_ = registrationinvitationMixinFields0
	...
	registrationinvitationDescCreateAt := registrationinvitationMixinFields0[0].Descriptor()
	...
	registrationinvitationDescUpdateAt := registrationinvitationMixinFields0[1].Descriptor()
	...
	registrationinvitationDescDeleteAt := registrationinvitationMixinFields0[2].Descriptor()
