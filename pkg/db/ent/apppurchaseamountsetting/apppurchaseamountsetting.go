...
const (
	// Label holds the string label denoting the apppurchaseamountsetting type in the database.
	Label = "app_purchase_amount_setting"
	...
	// Table holds the table name of the apppurchaseamountsetting in the database.
	Table = "app_purchase_amount_settings"
)

// Columns holds all SQL columns for apppurchaseamountsetting fields.
var Columns = []string{
	FieldID,
	FieldAppID,
	FieldTitle,
