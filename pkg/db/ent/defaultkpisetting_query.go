...
func (dksq *DefaultKpiSettingQuery) GroupBy(field string, fields ...string) *DefaultKpiSettingGroupBy {
	group := &DefaultKpiSettingGroupBy{config: dksq.config}
...
func (dksq *DefaultKpiSettingQuery) Select(fields ...string) *DefaultKpiSettingSelect {
	...
	return &DefaultKpiSettingSelect{DefaultKpiSettingQuery: dksq}
}
...
func (dksq *DefaultKpiSettingQuery) sqlAll(ctx context.Context) ([]*DefaultKpiSetting, error) {
	var (
...
func (dksgb *DefaultKpiSettingGroupBy) ScanX(ctx context.Context, v interface{}) {
	if err := dksgb.Scan(ctx, v); err != nil {
		panic(err)
	}
}
...
func (dksgb *DefaultKpiSettingGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(dksgb.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := dksgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (dksgb *DefaultKpiSettingGroupBy) StringsX(ctx context.Context) []string {
	v, err := dksgb.Strings(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (dksgb *DefaultKpiSettingGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	if v, err = dksgb.Strings(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (dksgb *DefaultKpiSettingGroupBy) StringX(ctx context.Context) string {
	v, err := dksgb.String(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (dksgb *DefaultKpiSettingGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(dksgb.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := dksgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (dksgb *DefaultKpiSettingGroupBy) IntsX(ctx context.Context) []int {
	v, err := dksgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (dksgb *DefaultKpiSettingGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	if v, err = dksgb.Ints(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (dksgb *DefaultKpiSettingGroupBy) IntX(ctx context.Context) int {
	v, err := dksgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (dksgb *DefaultKpiSettingGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(dksgb.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := dksgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (dksgb *DefaultKpiSettingGroupBy) Float64sX(ctx context.Context) []float64 {
	v, err := dksgb.Float64s(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (dksgb *DefaultKpiSettingGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	if v, err = dksgb.Float64s(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (dksgb *DefaultKpiSettingGroupBy) Float64X(ctx context.Context) float64 {
	v, err := dksgb.Float64(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (dksgb *DefaultKpiSettingGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(dksgb.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := dksgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (dksgb *DefaultKpiSettingGroupBy) BoolsX(ctx context.Context) []bool {
	v, err := dksgb.Bools(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// It is only allowed when executing a group-by query with one field.
func (dksgb *DefaultKpiSettingGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	if v, err = dksgb.Bools(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (dksgb *DefaultKpiSettingGroupBy) BoolX(ctx context.Context) bool {
	v, err := dksgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
// ScanX is like Scan, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) ScanX(ctx context.Context, v interface{}) {
	if err := dkss.Scan(ctx, v); err != nil {
		panic(err)
	}
}

// Strings returns list of strings from a selector. It is only allowed when selecting one field.
func (dkss *DefaultKpiSettingSelect) Strings(ctx context.Context) ([]string, error) {
	if len(dkss.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := dkss.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) StringsX(ctx context.Context) []string {
	v, err := dkss.Strings(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (dkss *DefaultKpiSettingSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	if v, err = dkss.Strings(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) StringX(ctx context.Context) string {
	v, err := dkss.String(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (dkss *DefaultKpiSettingSelect) Ints(ctx context.Context) ([]int, error) {
	if len(dkss.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := dkss.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) IntsX(ctx context.Context) []int {
	v, err := dkss.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (dkss *DefaultKpiSettingSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	if v, err = dkss.Ints(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) IntX(ctx context.Context) int {
	v, err := dkss.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (dkss *DefaultKpiSettingSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(dkss.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := dkss.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) Float64sX(ctx context.Context) []float64 {
	v, err := dkss.Float64s(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (dkss *DefaultKpiSettingSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	if v, err = dkss.Float64s(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) Float64X(ctx context.Context) float64 {
	v, err := dkss.Float64(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (dkss *DefaultKpiSettingSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(dkss.fields) > 1 {
		return nil, errors.New("ent: DefaultKpiSettingSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := dkss.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) BoolsX(ctx context.Context) []bool {
	v, err := dkss.Bools(ctx)
	if err != nil {
		panic(err)
	}
	return v
...
func (dkss *DefaultKpiSettingSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	if v, err = dkss.Bools(ctx); err != nil {
		return
	}
	switch len(v) {
	case 1:
	...
	case 0:
		err = &NotFoundError{defaultkpisetting.Label}
	default:
		err = fmt.Errorf("ent: DefaultKpiSettingSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (dkss *DefaultKpiSettingSelect) BoolX(ctx context.Context) bool {
	v, err := dkss.Bool(ctx)
	if err != nil {
		panic(err)
	}
