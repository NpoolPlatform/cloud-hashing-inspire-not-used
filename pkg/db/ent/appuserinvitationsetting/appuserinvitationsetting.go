...
const (
	// Label holds the string label denoting the appuserinvitationsetting type in the database.
	Label = "app_user_invitation_setting"
	...
	// Table holds the table name of the appuserinvitationsetting in the database.
	Table = "app_user_invitation_settings"
)

// Columns holds all SQL columns for appuserinvitationsetting fields.
var Columns = []string{
	FieldID,
	FieldAppID,
	FieldUserID,
